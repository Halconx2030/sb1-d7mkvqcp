/*
  # Configuración de almacenamiento y políticas

  1. Configuración
    - Crear buckets para avatares y fotos
    - Establecer permisos públicos
    - Configurar límites de tamaño
  
  2. Seguridad
    - Establecer políticas de acceso
    - Asegurar que solo los propietarios puedan modificar sus archivos
*/
...
-- Políticas mejoradas para avatares
...
-- Políticas mejoradas para fotos de progreso
